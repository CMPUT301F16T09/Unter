...
public class EditProfileUIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editConfirmPassword.setText(CurrentUser.getCurrentUser().getPassword());
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newPassword.equals(confirmPassword)){
                    try {
                        UserListOnlineController.UpdateUserTask update = new UserListOnlineController.UpdateUserTask();
                        ...
                        update.execute(CurrentUser.getCurrentUser());
                        ...
                        Toast.makeText(EditProfileUIActivity.this, "Your information failed to update." , Toast.LENGTH_SHORT).show();
